...
class GPT2Loader:   
    ...
    def let_the_model_speak(self):
        eva = EvaluateTrainModel()
        eva.generate_and_print_sample(self.gpt, self.tokenizer, device=self.device, start_context="Who is Yash in Karnataka?" )
...
if __name__ == "__main__":
    ...
    gpt2_loader.let_the_model_speak()
